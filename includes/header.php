                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto align-items-center">
                        <li class="nav-item me-2">
                            <a class="btn btn-outline-light" href="/rooms" style="display: inline-flex; align-items: center; gap: 0.25rem;">
                        ...
                        <li class="nav-item me-2">
                            <a class="btn btn-outline-light" href="/rooms/admin.php" style="display: inline-flex; align-items: center; gap: 0.25rem;">
